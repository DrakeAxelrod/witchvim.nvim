...
wv.g, wv.o, wv.wo, wv.bo, wv.opt = vim.g, vim.o, vim.wo, vim.bo, vim.opt
wv.loop = vim.loop
wv.fn = vim.fn
wv.api = vim.api
wv.cmd = vim.cmd
...
function wv.wisdom_of_the_ancients()
	...
	wv.opt.listchars = { -- visualize invisible symbols.
		tab       = "  ", -- 
-- eol      = "↴",
		space     = " ",  -- •
		nbsp      = "␣",
...
function wv.amnesia(built_ins)
	for i = 1, #built_ins do
		wv.g["loaded_" .. built_ins[i]] = 1
	end
end

function wv.necronomicon()
